 ...
 */
{
    ...
    class Slideshow {
            ...
            this.DOM.svg.innerHTML = `
                ...
                <linearGradient id="gradient1" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" stop-color="#fda085">
                        <!--animate attributeName="stop-color" values="#fda085; #f6d365; #fda085" dur="3s" repeatCount="indefinite"></animate-->
                    </stop>
                    <stop offset="100%" stop-color="#f6d365">
                        <!--animate attributeName="stop-color" values="#f6d365; #fda085; #f6d365" dur="3s" repeatCount="indefinite"></animate-->
                    </stop>
                </linearGradient>
                </defs>
        ...
        initEvents() {
            var _this=this;
            setInterval(function(){_this.navigate('next')},7000);
